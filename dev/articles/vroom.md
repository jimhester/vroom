...
to
[`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md).
The delimiter will be automatically guessed if it is a common delimiter;
...
[`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
and it will combine them into one result. vroom’s example datasets
include several files named like `mtcars-i.csv`. These files contain
subsets of the `mtcars` data, for cars with different numbers of
cylinders. First, we get a character vector of these filepaths.
...
[`col_types()`](https://jimhester.github.io/vroom/dev/reference/cols.md)
...
- [`vignette("benchmarks")`](https://jimhester.github.io/vroom/dev/articles/benchmarks.md)
