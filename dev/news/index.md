...
- Columns specified as having type “number” (requested via
  ...
  or `"number"` or `'n'`) or “skip” (requested via
  [`col_skip()`](https://jimhester.github.io/vroom/dev/reference/cols.md)
  or `"skip"` or `_` or `-`) now work in the case where 0 rows of data
  are parsed ([\#427](https://github.com/tidyverse/vroom/issues/427),
...
- [`vroom::problems()`](https://jimhester.github.io/vroom/dev/reference/problems.md)
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  reads more reliably from filepaths containing non-ascii characters, in
  a non-UTF-8 locale
...
- `col_factor(levels = NULL)` honors the `na` strings of
  [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  and its own `include_na` argument, as described in the docs, and now
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  no longer issues a spurious warning when the parsing needs to be
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now parses single digit datetimes more consistently as readr has done
  (<https://github.com/tidyverse/readr/issues/1276>)

- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now parses `Inf` values as doubles
  (<https://github.com/tidyverse/readr/issues/1283>)

- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now parses `NaN` values as doubles
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  no longer crashes if given a `col_name` and `col_type` both less than
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now respects the `quote` parameter properly in the first two lines of
  the file (<https://github.com/tidyverse/readr/issues/1262>)
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now always includes the last row when guessing
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now supports inputs with unnamed column types that are less than the
  number of columns
  ([\#296](https://github.com/tidyverse/vroom/issues/296))

- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now outputs the correct column names even in the presence of skipped
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now supports skipping comments and blank lines within data, not just
  at the start of the file
  ([\#294](https://github.com/tidyverse/vroom/issues/294),
  [\#302](https://github.com/tidyverse/vroom/issues/302))

- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now uses the tzdb package when parsing date-times
  ([@DavisVaughan](https://github.com/DavisVaughan),
  [\#273](https://github.com/tidyverse/vroom/issues/273))

- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now emits a warning of class `vroom_parse_issue` if there are
  non-fatal parsing issues.

- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now emits a warning of class `vroom_mismatched_column_name` if the
  user supplies a column type that does not match the name of a read
  column ([\#317](https://github.com/tidyverse/vroom/issues/317)).
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now correctly skips lines with only one quote if the format doesn’t
  use quoting
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now outputs a tibble with the expected number of columns and types
  based on `col_types` and `col_names` even if the file is empty
  ([\#297](https://github.com/tidyverse/vroom/issues/297)).

- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  no longer mis-indexes files read from connections with windows line
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  no longer crashes if `n_max = 0` and `col_names` is a character
  ([\#316](https://github.com/tidyverse/vroom/issues/316))

- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now preserves the spec attribute when vroom and readr are both loaded
  ([\#303](https://github.com/tidyverse/vroom/issues/303))

- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now allows specifying column names in `col_types` that have been
  repaired ([\#311](https://github.com/tidyverse/vroom/issues/311))

- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  no longer inadvertently calls `.name_repair` functions twice
  ([\#310](https://github.com/tidyverse/vroom/issues/310)).

- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  is now more robust to quoting issues when tracking the CSV state
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now signals an R error for invalid date and datetime formats, instead
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now works without error with readr versions of col specs
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now handles cases when `id` is set and a column in skipped
  ([\#237](https://github.com/tidyverse/vroom/issues/237))

- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now supports column selections when there are some empty column names
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now writes the column names if given an input with no rows
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  no longer truncates the last value in a file if the file contains
  windows newlines but no final newline
  ([\#219](https://github.com/tidyverse/vroom/issues/219)).

- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now works when the `na` argument is encoded in non ASCII or UTF-8
  locales *and* the file encoding is not the same as the native encoding
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now supports reading Big Integer values with the `bit64` package. Use
  [`col_big_integer()`](https://jimhester.github.io/vroom/dev/reference/cols.md)
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  can now read single line files without a terminal newline
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now correctly copies string data for factor levels
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now includes a spec object with the `col_types` class, as intended.
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  ...
  error if a delimiter cannot be guessed
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now has an improved error message when a file does not exist
...
- [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  no longer overflows when reading files with more than 2B entries
...
- Default message output from
  [`vroom()`](https://jimhester.github.io/vroom/dev/reference/vroom.md)
  now uses `Rows` and `Cols` ([@meta00](https://github.com/meta00),
