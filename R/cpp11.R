...
vroom_lines_libvroom_ <- function(input, skip, na_values, skip_empty_rows, num_threads, use_altrep) {
  .Call(`_vroom_vroom_lines_libvroom_`, input, skip, na_values, skip_empty_rows, num_threads, use_altrep)
}
